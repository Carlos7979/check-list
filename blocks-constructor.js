        ...
        const block = elementsCreator("DIV", `block-${i+1}`, 'block', false, {counter: 'hidden'});
            const blockAdvancedOptions = elementsCreator("DIV", `blockAdvancedOptions-${i+1}`, 'block-advanced-options');
                const blockAdvancedPrimaryContainer = elementsCreator("div", `blockAdvancedPrimaryContainer-${i+1}`, 'blockAdvancedPrimaryContainer');
                    const hideOptionsIconsContainer = elementsCreator("div", `hideOptionsIconsContainer-${i+1}`, 'hideOptionsIconsContainer', false, {hidden: 'hidden'});
                        ...
                        const copyContainer = elementsCreator('div', `copyContainer-${i +1}`, 'block-advanced-icons-containers');
                        ...
                        const cleanContainer = elementsCreator('div', `cleanContainer-${i +1}`, 'block-advanced-icons-containers');
                            const clean = elementsCreator('img', `clean-${i+1}`, 'icon-button-block', false, {src: 'images/edit-clear.svg', alt: 'Block clean', title: 'Limpiar bloque'});
                        cleanContainer.appendChild(clean);
                        const deleteContainer = elementsCreator('div', `deleteContainer-${i +1}`, 'block-advanced-icons-containers');
                    ...
                    severalAppends(hideOptionsIconsContainer, [moveContainer, copyContainer, cleanContainer, deleteContainer]);
                    // severalAppends(hideOptionsIconsContainer, [configContainer, moveContainer, copyContainer, cleanContainer, deleteContainer]);
                    const configHideManageContainer = elementsCreator('div', `configHideManageContainer-${i +1}`, 'hideOptionsIconsContainer', false, {hidden: 'hidden'});
                        const configManageContainer  = elementsCreator('div', `configManageContainer-${i +1}`, 'manageContainer');
                    ...
                    const moveHideManageContainer = elementsCreator('div', `moveHideManageContainer-${i +1}`, 'hideOptionsIconsContainer', false, {hidden: 'hidden'});
                        const moveManageContainer  = elementsCreator('div', `moveManageContainer-${i +1}`, 'manageContainer');
                    ...
                    const copyHideManageContainer = elementsCreator('div', `copyHideManageContainer-${i +1}`, 'hideOptionsIconsContainer', false, {hidden: 'hidden'});
                        const copyManageContainer  = elementsCreator('div', `copyManageContainer-${i +1}`, 'manageContainer');
                            const [copySelector, copyArray] = blockSelector('copy', 'Copiar bloque', i, n);
                            severalAppends(copySelector, copyArray);
                            const labelCopyBlock = elementsCreator('label', `labelCopy-${i +1}`, 'labelCopy', 'Copiar el contenido del bloque:', {for: `copySelector-${i+1}`});
                            const copyButtonContainer = elementsCreator('span', `copyButtonContainer-${i + 1}`, 'copyButtonContainer', false, {hidden: 'hidden'});
                    ...
                    const cleanHideManageContainer = elementsCreator('div', `cleanHideManageContainer-${i +1}`, 'hideOptionsIconsContainer', false, {hidden: 'hidden'});
                        const cleanManageContainer  = elementsCreator('div', `cleanManageContainer-${i +1}`, 'manageContainer');
                            const cleanText = elementsCreator('span', `cleanText-${i + 1}`, 'cleanText', 'Nada por limpiar', {hidden: 'hidden'});
                            const cleanButtonContainer = elementsCreator('span', `cleanButtonContainer-${i + 1}`, 'cleanButtonContainer');
                                const cleanButton = elementsCreator('span', `cleanButton-${i + 1}`, 'button-darkgreen-confirm-block', 'Limpiar actividades realizadas', {hidden: 'hidden'});
                            cleanButtonContainer.appendChild(cleanButton);
                            const sortButtonContainer = elementsCreator('span', `sortButtonContainer-${i + 1}`, 'sortButtonContainer');
                                const sortButton = elementsCreator('span', `sortButton-${i + 1}`, 'button-darkgreen-confirm-block', 'Desplazar espacios vacíos', {hidden: 'hidden'});
                    ...
                    const deleteBlockHideManageContainer = elementsCreator('div', `deleteBlockHideManageContainer-${i +1}`, 'hideOptionsIconsContainer', false, {hidden: 'hidden'});
                        const deleteManageContainer  = elementsCreator('div', `deleteManageContainer-${i +1}`, 'manageContainer');
                    ...
                    const confirmHideManageContainer = elementsCreator('div', `confirmHideManageContainer-${i +1}`, 'hideOptionsIconsContainer', false, {hidden: 'hidden'});
                        const confirmManageContainer  = elementsCreator('div', `confirmManageContainer-${i +1}`, 'manageContainer');
                            const confirmText = elementsCreator('span', `confirmText-${i +1}`, 'confirmText');
                            const confirmAcceptButtonContainer = elementsCreator('span', `confirmAcceptButtonContainer-${i + 1}`, 'confirmButtonContainer');
                                const confirmAcceptButton = elementsCreator('span', `confirmAcceptButton-${i + 1}`, 'button-darkgreen-confirm-block', 'Aceptar');
                            confirmAcceptButtonContainer.appendChild(confirmAcceptButton);
                            const confirmCancelButtonContainer = elementsCreator('span', `confirmCancelButtonContainer-${i + 1}`, 'confirmButtonContainer');
                                const confirmCancelButton = elementsCreator('span', `confirmCancelButton-${i + 1}`, 'button-darkred-confirm-block', 'Cancelar');
                            confirmCancelButtonContainer.appendChild(confirmCancelButton);
                        severalAppends(confirmManageContainer, [confirmText, confirmAcceptButtonContainer, confirmCancelButtonContainer]);
                    severalAppends(confirmHideManageContainer, [confirmManageContainer]);
                severalAppends(blockAdvancedPrimaryContainer, [hideOptionsIconsContainer, configHideManageContainer, moveHideManageContainer, copyHideManageContainer, cleanHideManageContainer, deleteBlockHideManageContainer, confirmHideManageContainer]);
