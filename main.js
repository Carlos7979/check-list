function main() {
	...
	closeScheduleOptions(
		document.getElementById('overlay-options-container-4')
	);
	...
	passSeveralElementsInFunction(
		advancedOptions,
		document.getElementsByClassName('advanced-options')
	);
	passSeveralElementsInFunction(
		importExportButtons,
		document.getElementsByClassName('import-export')
	);
	passSeveralElementsInFunction(
		newBlock,
		document.getElementsByClassName('new-block')
	);
	passSeveralElementsInFunction(
		cleanBlocks,
		document.getElementsByClassName('clean-blocks')
	);
	passSeveralElementsInFunction(
		deleteSchedule,
		document.getElementsByClassName('delete-schedule')
	);
}
